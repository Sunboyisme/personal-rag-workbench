          ...
          setMessages([
            {
              id: 'welcome',
              role: 'assistant',
              content: '你好，我是你的个人知识库助手。请先在右上角进入「后台配置」导入笔记并建库，然后就可以在这里提问了。',
            },
          ]);
        }
      }
  ...
  async function handleSend(event) {
    ...
    try {
      ...
      const result = await api.chat(
        { question, collectionId, recipeId: recipeId || undefined },
        {
          onRetrieval: (data) => { traceData = data; },
          onToken: (text) => {
            setMessages((prev) =>
              prev.map((m) =>
      ...
      <header className="chat-header">
        ...
        <div className="chat-header-actions">
          ...
          <button
            ...
            onClick={(e) => navigate(e, '/admin/sources')}
          >
            后台配置
          </button>
        </div>
